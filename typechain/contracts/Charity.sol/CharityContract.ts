...
export interface CharityContractInterface extends utils.Interface {
  functions: {
...
export interface CharityContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CharityContractInterface;
