...
export interface HelloWorldContractInterface extends utils.Interface {
  functions: {
    "getNumber()": FunctionFragment;
    "helloWorld()": FunctionFragment;
    "number()": FunctionFragment;
    "setNumber(int256)": FunctionFragment;
  };

  getFunction(
    nameOrSignatureOrTopic: "getNumber" | "helloWorld" | "number" | "setNumber"
  ): FunctionFragment;
...
export interface HelloWorldContract extends BaseContract {
